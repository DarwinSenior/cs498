...
if __name__ == '__main__':
    ...
    if run_part1:
        ...
        write_result('svm_first.csv', trainer.predict(scaler.transform(eval_set)))
        ...
        write_result('svm_second.csv', trainer.predict(scaler.transform(eval_set)))
        ...
        write_result('svm_third.csv', trainer.predict(scaler.transform(eval_set)))
        ...
        write_result('svm_forth.csv', trainer.predict(scaler.transform(eval_set)))
        ...
        trainer.fit(datax, datay)
        score = trainer.score(testx, testy)
        write_result('nb_first.csv', trainer.predict(scaler.transform(eval_set)))
        print("the score for raw data is %f" % score)
        ...
        trainer.fit(minus_app(datax), datay)
        score = trainer.score(minus_app(testx), testy)
        write_result('nb_second.csv', trainer.predict(scaler.transform(eval_set)))
        print("the score for difference is %f" % score)
        ...
        write_result('nb_two_point_five.csv', trainer.predict(scaler.transform(eval_set)))
        ...
        trainer.fit(devide_app(datax), datay)
        score = trainer.score(devide_app(testx), testy)
        write_result('nb_third.csv', trainer.predict(scaler.transform(eval_set)))
        print("the score for ratio is %f" % score)
        ...
        trainer.fit(plus_app(datax), datay)
        score = trainer.score(plus_app(testx), testy)
        write_result('nb_forth.csv', trainer.predict(scaler.transform(eval_set)))
        print("the score for sum is %f" % score)
        ...
        trainer.fit(datax, datay)
        score = trainer.score(testx, testy)
        write_result('rf_first.csv', trainer.predict(scaler.transform(eval_set)))
        print("the score for raw data is %f" % score)
        ...
        trainer.fit(minus_app(datax), datay)
        score = trainer.score(minus_app(testx), testy)
        write_result('rf_second.csv', trainer.predict(scaler.transform(eval_set)))
        print("the score for difference is %f" % score)
        ...
        trainer.fit(minus_abs_app(datax), datay)
        score = trainer.score(minus_abs_app(testx), testy)
        write_result('rf_two_point_five.csv', trainer.predict(scaler.transform(eval_set)))
        print("the score for abs difference is %f" % score)
        ...
        trainer.fit(devide_app(datax), datay)
        score = trainer.score(devide_app(testx), testy)
        write_result('rf_third.csv', trainer.predict(scaler.transform(eval_set)))
        print("the score for ratio is %f" % score)
        ...
        trainer.fit(plus_app(datax), datay)
        score = trainer.score(plus_app(testx), testy)
        write_result('rf_forth.csv', trainer.predict(scaler.transform(eval_set)))
        print("the score for sum is %f" % score)
